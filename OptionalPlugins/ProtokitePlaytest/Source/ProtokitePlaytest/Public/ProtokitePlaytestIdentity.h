...
struct PROTOKITEPLAYTEST_API FProtokitePlaytestIdentity
{
	GENERATED_BODY()
...
struct FProtokitePlaytestRunningSteamAccount
{
	FString Id;
	FString Nickname;
};
 ...
 */
PROTOKITEPLAYTEST_API FProtokitePlaytestRunningSteamAccount ReadRunningSteamAccount();
 ...
 */
PROTOKITEPLAYTEST_API bool IsUsablePlaytestId(const FString& Id, int32 MaxLength);

/** What reading the device id file found. */
enum class EProtokitePlaytestDeviceIdFileResult : uint8
{
...
class PROTOKITEPLAYTEST_API FProtokitePlaytestDeviceIdFile
{
public:
	explicit FProtokitePlaytestDeviceIdFile(const FString& InPath);

	/** ProtokitePlaytest/device_id.txt in the project's Saved folder. */
	 ...
	 */
	EProtokitePlaytestDeviceIdFileResult ReadOrCreate(FString& OutDeviceId) const;
