 ...
 */
struct PROTOKITEPLAYTEST_API FProtokitePlaytestFormSubmission
{
	...
	static bool FromSavedJson(const FString& Json, FProtokitePlaytestFormSubmission& OutSubmission, FString& OutError);
 ...
 */
PROTOKITEPLAYTEST_API FString ProtokitePlaytestFindFieldIdInComplaint(const FString& Message);
