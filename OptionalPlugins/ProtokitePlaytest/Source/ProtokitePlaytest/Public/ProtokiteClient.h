 ...
 */
class PROTOKITEPLAYTEST_API FProtokiteClient : public FFlockProviderBase
{
public:
	...
	FFlockRequestHandle FetchPlaytestConfig(const FString& ProtokiteApiUrl, const TMap<FString, FString>& RequestHeaders,
		TFunction<void(TFlockResult<FProtokitePlaytestConfig>)> OnComplete);
	...
	FFlockRequestHandle StartPlaytestSession(const FString& ProtokiteApiUrl, const TMap<FString, FString>& RequestHeaders,
		const FProtokitePlaytestSessionStartRequest& Request, TFunction<void(TFlockResult<FProtokitePlaytestSessionStartResult>)> OnComplete);
	...
	FFlockRequestHandle EndPlaytestSession(const FString& ProtokiteApiUrl, const TMap<FString, FString>& RequestHeaders,
		const FString& PlaytestSessionId, TFunction<void(TFlockResult<FProtokitePlaytestSessionEndResult>)> OnComplete);
