 ...
 */
USTRUCT()
struct PROTOKITEPLAYTEST_API FProtokitePlaytestRecordingUploadLink
{
	GENERATED_BODY()
	...
	static bool FromWireObject(const TSharedRef<FJsonObject>& Object, FProtokitePlaytestRecordingUploadLink& OutLink, FString& OutError);
};
