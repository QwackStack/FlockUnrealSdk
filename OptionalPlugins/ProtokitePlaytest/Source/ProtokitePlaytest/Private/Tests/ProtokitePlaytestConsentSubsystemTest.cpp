...
namespace
{
	...
	{
		FString Error;
		const TSharedPtr<FProtokitePlaytestRecordingRun> Run = FProtokitePlaytestRecordingRun::CreateNamedForTesting(
			RecordingsFolder, EProtokitePlaytestRecordingKind::Playtest, TEXT("2026-09-21-000000-aaaaaaaa"), /*ReservedBytes*/ 0, Error);
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentWaitsForTheAnswerTest,
	"Protokite.Playtest.Consent.NothingIsCollectedUntilThePlayerAnswers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentWaitsForTheAnswerTest::RunTest(const FString& Parameters)
{
	...
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::NotAnswered);
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentAnsweringStartsItTest,
	"Protokite.Playtest.Consent.AnsweringStartsThePlaytest",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentAnsweringStartsItTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings Analytics(/*bAnalyticsEnabled*/ true);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::NotAnswered);
	...
	TestTrue(TEXT("The player answers"),
		Fixture.Playtest->SetPlaytestConsent(EProtokitePlaytestConsentChoice::VideoAndPlayData));

	ExpectPlaytestStatus(*this, TEXT("Playtesting is ready"), Fixture.Playtest->GetStatus(), EProtokitePlaytestStatus::Ready);
	TestFalse(TEXT("And nothing is waiting to ask them any more"), Fixture.Playtest->IsWaitingToAskForConsentForTesting());
	TestTrue(TEXT("Video recording is on"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::VideoRecording));
	TestTrue(TEXT("Heavy analytics is on"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::HeavyAnalytics));
	...
	const FProtokitePlaytestConsentFile Saved(Fixture.ConsentFilePath);
	TestEqual(TEXT("The answer is kept for the next launch"), static_cast<int32>(Saved.Read()),
		static_cast<int32>(EProtokitePlaytestConsentChoice::VideoAndPlayData));
	return true;
}

/** Collecting nothing is the same build behaviour as Enable Playtesting being off, which is what the player is told. */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentNothingTest,
	"Protokite.Playtest.Consent.NothingReadsLikePlaytestingTurnedOff",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentNothingTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings Analytics(/*bAnalyticsEnabled*/ true);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::Nothing);
	AnswerConfigWithEveryFeature(Fixture);
	Fixture.StartFlock();
	Fixture.RegisterFlockSession(ConsentTestFlockSessionId);
	...
	TestFalse(TEXT("Video recording is off"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::VideoRecording));
	TestFalse(TEXT("Heavy analytics is off"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::HeavyAnalytics));
	TestFalse(TEXT("Nothing is being measured"), Fixture.Playtest->IsMeasuringPerformance());
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentVideoOnlyTest,
	"Protokite.Playtest.Consent.VideoOnlyLeavesPlayDataOut",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentVideoOnlyTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings Analytics(/*bAnalyticsEnabled*/ true);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::VideoOnly);
	AnswerConfigWithEveryFeature(Fixture);
	Fixture.StartFlock();
	Fixture.RegisterFlockSession(ConsentTestFlockSessionId);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentPlayDataOnlyTest,
	"Protokite.Playtest.Consent.PlayDataOnlyLeavesTheScreenOut",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentPlayDataOnlyTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings Analytics(/*bAnalyticsEnabled*/ true);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::PlayDataOnly);
	AnswerConfigWithEveryFeature(Fixture);
	Fixture.StartFlock();
	Fixture.RegisterFlockSession(ConsentTestFlockSessionId);
	...
	TestTrue(TEXT("Play data is collected"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::HeavyAnalytics));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentSessionFieldsTest,
	"Protokite.Playtest.Consent.TheSessionSaysWhatItMayCollect",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentSessionFieldsTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::VideoOnly);
	Fixture.StartFlock();
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentNotAskedTest,
	"Protokite.Playtest.Consent.ABuildThatDoesNotAskCollectsEverythingAndSaysSo",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentNotAskedTest::RunTest(const FString& Parameters)
{
	...
	TestFalse(TEXT("Nobody answered"), ProtokitePlaytestConsent::IsAnswered(Fixture.Playtest->GetPlayersConsentAnswer()));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentOutlivesTheSettingTest,
	"Protokite.Playtest.Consent.AnAnswerOutlivesABuildThatStopsAsking",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentOutlivesTheSettingTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl, /*bAskThePlayerForPlaytestConsent*/ false);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::PlayDataOnly);
	AnswerConfigWithEveryFeature(Fixture);
	...
	TestEqual(TEXT("Their answer is what the build collects under"), static_cast<int32>(Fixture.Playtest->GetPlaytestConsent()),
		static_cast<int32>(EProtokitePlaytestConsentChoice::PlayDataOnly));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentForgettingTest,
	"Protokite.Playtest.Consent.ForgettingTheAnswerAsksAgain",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentForgettingTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::VideoAndPlayData);
	AnswerConfigWithEveryFeature(Fixture);
	Fixture.StartFlock();
	ExpectPlaytestStatus(*this, TEXT("Precondition: it is ready"), Fixture.Playtest->GetStatus(), EProtokitePlaytestStatus::Ready);

	TestTrue(TEXT("The answer is forgotten"), Fixture.Playtest->SetPlaytestConsent(EProtokitePlaytestConsentChoice::NotAnswered));
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentEarlierRecordingsTest,
	"Protokite.Playtest.Consent.NothingStopsWhatEarlierLaunchesLeft",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentEarlierRecordingsTest::RunTest(const FString& Parameters)
{
	// Both halves of one test, so the difference between them is the answer and nothing else.
	for (const EProtokitePlaytestConsentChoice Answer : { EProtokitePlaytestConsentChoice::VideoAndPlayData,
		EProtokitePlaytestConsentChoice::Nothing })
	{
		const bool bShouldBeSent = Answer != EProtokitePlaytestConsentChoice::Nothing;
		const FString Which = ProtokitePlaytestConsent::ToWire(Answer);
		...
		const TArray<FProtokitePlaytestRecordingWaitingToUpload> Waiting =
			FProtokitePlaytestRecordingsFolder::FindRecordingsWaitingToUpload(Recordings);
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentEarlierRecordingsWaitTest,
	"Protokite.Playtest.Consent.WhatEarlierLaunchesLeftWaitsForTheAnswer",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentEarlierRecordingsWaitTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::NotAnswered);
	...
	TestTrue(TEXT("The player answers"), Fixture.Playtest->SetPlaytestConsent(EProtokitePlaytestConsentChoice::VideoAndPlayData));
	RunPendingPlaytestRetries();
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestConsentEarlierRecordingsChangeOfMindTest,
	"Protokite.Playtest.Consent.ChangingTheAnswerSendsWhatWasWaiting",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestConsentEarlierRecordingsChangeOfMindTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture(/*bTurnRetriesOff*/ true, /*bUseTestIdentitySources*/ true, EProtokitePlaytestConsentChoice::Nothing);
	...
	TestTrue(TEXT("They change their mind"), Fixture.Playtest->SetPlaytestConsent(EProtokitePlaytestConsentChoice::VideoOnly));
	RunPendingPlaytestRetries();
