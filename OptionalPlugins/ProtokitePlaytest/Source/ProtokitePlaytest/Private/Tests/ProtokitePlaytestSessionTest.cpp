...
#include "ProtokitePlaytestIdentity.h"
...
namespace
{
	void ExpectSessionState(FAutomationTestBase& Test, const FString& What, EProtokitePlaytestSessionState Actual,
		EProtokitePlaytestSessionState Expected)
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionStartsFromTheFirstFlockSessionToReachTheServerTest,
	"Protokite.Playtest.Session.StartsFromTheFirstFlockSessionToReachTheServer",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionStartsFromTheFirstFlockSessionToReachTheServerTest::RunTest(const FString& Parameters)
{
	...
	ExpectSessionState(*this, TEXT("Started"), Fixture.Playtest->GetPlaytestSessionState(), EProtokitePlaytestSessionState::Started);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionWaitsForThePlaytestConfigTest,
	"Protokite.Playtest.Session.WaitsForThePlaytestConfig",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionWaitsForThePlaytestConfigTest::RunTest(const FString& Parameters)
{
	{
		FScopedPlaytestSettings Settings(true, UsableUrl);
		FPlaytestFixture Fixture;
	...
	}
	{
		...
		Fixture.Transport->AnswerInOrder(PlaytestConfigRoute, {
			FProtokitePlaytestFakeTransport::ConnectionFailure(), FProtokitePlaytestFakeTransport::Status(200, ConfigBody()) });
		Fixture.StartFlock();
		Fixture.RegisterFlockSession(FirstFlockSessionId);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionRotationAndSignOutNeitherEndNorRestartTest,
	"Protokite.Playtest.Session.RotationAndSignOutNeitherEndNorRestart",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionRotationAndSignOutNeitherEndNorRestartTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.StartFlock();
	...
	ExpectSessionState(*this, TEXT("Still started"), Fixture.Playtest->GetPlaytestSessionState(), EProtokitePlaytestSessionState::Started);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionFlockShuttingDownNeitherEndsNorRestartsItTest,
	"Protokite.Playtest.Session.FlockShuttingDownNeitherEndsNorRestartsIt",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionFlockShuttingDownNeitherEndsNorRestartsItTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.StartFlock();
	...
	ExpectSessionState(*this, TEXT("Still started once the Flock SDK shuts down"), Fixture.Playtest->GetPlaytestSessionState(),
		EProtokitePlaytestSessionState::Started);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionFlockSessionOfAnEndedInitializationIsNotUsedTest,
	"Protokite.Playtest.Session.FlockSessionOfAnEndedInitializationIsNotUsed",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionFlockSessionOfAnEndedInitializationIsNotUsedTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.Transport->AnswerInOrder(PlaytestConfigRoute, {
		FProtokitePlaytestFakeTransport::Status(503, FlockUnreachableBody), FProtokitePlaytestFakeTransport::Status(200, ConfigBody()) });
	Fixture.StartFlock();
	Fixture.RegisterFlockSession(FirstFlockSessionId);

	Fixture.Flock->ShutdownSdk();
	Fixture.Flock->InitializeWithConfig(MakeFlockConfig());
	ExpectPlaytestStatus(*this, TEXT("Ready in the second initialization"), Fixture.Playtest->GetStatus(), EProtokitePlaytestStatus::Ready);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionStartIsNeverTriedTwiceTest,
	"Protokite.Playtest.Session.StartIsNeverTriedTwice",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionStartIsNeverTriedTwiceTest::RunTest(const FString& Parameters)
{
	struct FCase
	{
	...
	const FCase Cases[] = {
		{ FProtokitePlaytestFakeTransport::ConnectionFailure(), false, EProtokitePlaytestSessionState::StartFailed, TEXT("No connection") },
		{ FProtokitePlaytestFakeTransport::TimedOut(), false, EProtokitePlaytestSessionState::StartFailed, TEXT("A timeout") },
		{ FProtokitePlaytestFakeTransport::Status(503, FlockUnreachableBody), false, EProtokitePlaytestSessionState::StartFailed, TEXT("HTTP 503") },
		{ FProtokitePlaytestFakeTransport::Status(429, TEXT("{}")), false, EProtokitePlaytestSessionState::StartFailed, TEXT("HTTP 429") },
		{ FProtokitePlaytestFakeTransport::Status(401, InvalidApiKeyBody), false, EProtokitePlaytestSessionState::StartFailed, TEXT("HTTP 401") },
		{ FProtokitePlaytestFakeTransport::Status(404, NotLinkedBody), false, EProtokitePlaytestSessionState::StartFailed, TEXT("HTTP 404") },
		{ FProtokitePlaytestFakeTransport::Status(422, NoPlayerIdentityBody), false, EProtokitePlaytestSessionState::StartFailed, TEXT("HTTP 422") },
		{ FProtokitePlaytestFakeTransport::Status(200, Envelope(TEXT("{}"))), false, EProtokitePlaytestSessionState::StartFailed, TEXT("A 200 without a session id") },
		{ FProtokitePlaytestFakeTransport::Status(200, SessionStartBody()), true, EProtokitePlaytestSessionState::Starting, TEXT("An answer that never arrives") },
	};
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionClosedPlaytestStopsPlaytestingForTheLaunchTest,
	"Protokite.Playtest.Session.ClosedPlaytestStopsPlaytestingForTheLaunch",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionClosedPlaytestStopsPlaytestingForTheLaunchTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.Transport->Answer(PlaytestSessionStartRoute, FProtokitePlaytestFakeTransport::Status(400, NoLongerCollectingBody));
	FPlaytestLogCapture Capture;
	Fixture.StartFlock();
	Fixture.RegisterFlockSession(FirstFlockSessionId);

	ExpectPlaytestStatus(*this, TEXT("A closed playtest"), Fixture.Playtest->GetStatus(), EProtokitePlaytestStatus::PlaytestNoLongerCollecting);
	ExpectSessionState(*this, TEXT("Start failed"), Fixture.Playtest->GetPlaytestSessionState(), EProtokitePlaytestSessionState::StartFailed);
	TestFalse(TEXT("Every feature is off"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::VideoRecording));
	const TArray<FPlaytestLogCapture::FLine> Closed =
		Capture.LinesContaining(DescribePlaytestStatus(EProtokitePlaytestStatus::PlaytestNoLongerCollecting));
	...
	TestFalse(TEXT("Every feature is still off"), Fixture.Playtest->IsPlaytestFeatureEnabled(ProtokitePlaytestFeatures::VideoRecording));
	TestEqual(TEXT("Still reported once"),
		Capture.LinesContaining(DescribePlaytestStatus(EProtokitePlaytestStatus::PlaytestNoLongerCollecting)).Num(), 1);
	return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionQuitEndsTheSessionTest,
	"Protokite.Playtest.Session.QuitEndsTheSession",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionQuitEndsTheSessionTest::RunTest(const FString& Parameters)
{
	{
		FScopedPlaytestSettings Settings(true, UsableUrl);
		FPlaytestFixture Fixture;
		...
		ExpectSessionState(*this, TEXT("Ended"), Fixture.Playtest->GetPlaytestSessionState(), EProtokitePlaytestSessionState::Ended);
	}
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionEndUsesTheStartsAddressAndHeadersTest,
	"Protokite.Playtest.Session.EndUsesTheStartsAddressAndHeaders",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionEndUsesTheStartsAddressAndHeadersTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.StartFlock();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionEndingTwiceSendsTwoEndsTest,
	"Protokite.Playtest.Session.EndingTwiceSendsTwoEnds",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionEndingTwiceSendsTwoEndsTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	FPlaytestLogCapture Capture;
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionEndReportsWhetherItWasTakenTest,
	"Protokite.Playtest.Session.EndingOnDemandReportsWhetherProtokiteTookIt",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionEndReportsWhetherItWasTakenTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.StartFlock();
	...
	Heard.Reset();
	Fixture.Transport->Answer(PlaytestSessionEndRoute, FProtokitePlaytestFakeTransport::Status(500, TEXT("{\"detail\":\"Internal Server Error\"}")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionStartAnsweredAfterTeardownIsEndedTest,
	"Protokite.Playtest.Session.StartAnsweredAfterTeardownIsEnded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionStartAnsweredAfterTeardownIsEndedTest::RunTest(const FString& Parameters)
{
	{
		FScopedPlaytestSettings Settings(true, UsableUrl);
		FPlaytestFixture Fixture;
	...
	}
	{
		...
		FScopedPlaytestSettings Settings(true, UsableUrl);
		FPlaytestFixture Fixture;
		Fixture.Transport->Answer(PlaytestSessionStartRoute, FProtokitePlaytestFakeTransport::Status(503, FlockUnreachableBody));
		Fixture.StartFlock();
		Fixture.Transport->bHoldReplies = true;
		Fixture.RegisterFlockSession(FirstFlockSessionId);
		Fixture.Playtest->Deinitialize();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionNoPlayerIdentitySendsNothingTest,
	"Protokite.Playtest.Session.NoPlayerIdentitySendsNothing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionNoPlayerIdentitySendsNothingTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	...
	ExpectSessionState(*this, TEXT("No identity"), Fixture.Playtest->GetPlaytestSessionState(), EProtokitePlaytestSessionState::NoPlayerIdentity);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionSteamIdWhenSteamIsRunningTest,
	"Protokite.Playtest.Session.SteamIdWhenSteamIsRunning",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionSteamIdWhenSteamIsRunningTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionNothingIsResolvedOrSentUntilAStartTest,
	"Protokite.Playtest.Session.NothingIsResolvedOrSentUntilAStart",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionNothingIsResolvedOrSentUntilAStartTest::RunTest(const FString& Parameters)
{
	{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionLogsTheWaitAndTheStartOnceTest,
	"Protokite.Playtest.Session.LogsTheWaitAndTheStartOnce",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionLogsTheWaitAndTheStartOnceTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	FPlaytestLogCapture Capture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionStartCarriesTheBuildFactsTest,
	"Protokite.Playtest.Session.StartCarriesTheBuildFacts",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionStartCarriesTheBuildFactsTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.StartFlock();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionFlockSessionIdThatDoesNotFitIsLeftOutTest,
	"Protokite.Playtest.Session.FlockSessionIdThatDoesNotFitIsLeftOut",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionFlockSessionIdThatDoesNotFitIsLeftOutTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	FPlaytestLogCapture Capture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestSessionWithoutTestSourcesUsesTheDeviceIdUnderSavedTest,
	"Protokite.Playtest.Session.WithoutTestSourcesUsesTheDeviceIdUnderSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestSessionWithoutTestSourcesUsesTheDeviceIdUnderSavedTest::RunTest(const FString& Parameters)
{
	...
	FString DeviceId;
	FProtokitePlaytestDeviceIdFile(FProtokitePlaytestDeviceIdFile::GetDefaultPath()).ReadOrCreate(DeviceId);
	const TSharedPtr<FJsonObject> Body = Fixture.LastSessionStartBody();
