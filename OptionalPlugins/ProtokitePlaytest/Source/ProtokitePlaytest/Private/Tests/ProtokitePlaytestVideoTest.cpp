...
#include "ProtokitePlaytestVideoFrameSchedule.h"
...
namespace
{
	using EFrameResult = FProtokitePlaytestVideoFrameSchedule::EFrameResult;

	/** Hands the schedule each frame time, and returns the index and time of every frame it captured. */
	TArray<TPair<int32, int64>> CapturedFrames(FProtokitePlaytestVideoFrameSchedule& Schedule, const TArray<double>& FrameSeconds)
	{
	...
	{
		return FPaths::Combine(FPaths::ProjectIntermediateDir(), TEXT("ProtokitePlaytestTests"), FGuid::NewGuid().ToString(EGuidFormats::Digits), Name);
	}
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoScheduleCapturesAtTheFrameRateTest,
	"Protokite.Playtest.Video.Schedule.CapturesAtTheFrameRate",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoScheduleCapturesAtTheFrameRateTest::RunTest(const FString& Parameters)
{
	{
		FProtokitePlaytestVideoFrameSchedule Schedule(30, 3600.0);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoScheduleWobblyFrameTimesTest,
	"Protokite.Playtest.Video.Schedule.WobblyFrameTimesStillCaptureEveryOtherFrame",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoScheduleWobblyFrameTimesTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoScheduleLeavesOutFramesTest,
	"Protokite.Playtest.Video.Schedule.LeavesOutTheFrameAfterTheBackground",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoScheduleLeavesOutFramesTest::RunTest(const FString& Parameters)
{
	FProtokitePlaytestVideoFrameSchedule Schedule(30, 3600.0);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoScheduleStopsAtTheLengthLimitTest,
	"Protokite.Playtest.Video.Schedule.StopsAtTheLengthLimit",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoScheduleStopsAtTheLengthLimitTest::RunTest(const FString& Parameters)
{
	FProtokitePlaytestVideoFrameSchedule Schedule(30, 1.0);
	int32 Captures = 0;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoScheduleNeverRepeatsATimeTest,
	"Protokite.Playtest.Video.Schedule.NeverRepeatsATime",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoScheduleNeverRepeatsATimeTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoFitsInsideTheVideoSizeTest,
	"Protokite.Playtest.Video.FitsInsideTheVideoSize",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoFitsInsideTheVideoSizeTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoWhyVideoCannotBeRecordedTest,
	"Protokite.Playtest.Video.WhyVideoCannotBeRecorded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoWhyVideoCannotBeRecordedTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoSettingsKeptInRangeTest,
	"Protokite.Playtest.Video.SettingsAreKeptInRange",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoSettingsKeptInRangeTest::RunTest(const FString& Parameters)
{
	const UProtokitePlaytestSettings* Defaults = NewObject<UProtokitePlaytestSettings>(GetTransientPackage());
	const FProtokitePlaytestVideoSettings FromDefaults = FProtokitePlaytestVideoSettings::FromProjectSettings(*Defaults);
	...
	TestEqual(TEXT("Room is made for an hour at 2000 kbps, a quarter more, and each frame's header"), FromDefaults.BytesToMakeRoomFor(),
		static_cast<int64>(2000 * 125.0 * 3600 * 1.25)
			+ FProtokitePlaytestVideoFile::FileHeaderBytes + 108000 * FProtokitePlaytestVideoFile::FrameHeaderBytes);
	FProtokitePlaytestVideoSettings FiveSeconds = FromDefaults;
	...
	TestEqual(TEXT("A five-second recording needs far less"), FiveSeconds.BytesToMakeRoomFor(),
		static_cast<int64>(2000 * 125.0 * 5 * 1.25)
			+ FProtokitePlaytestVideoFile::FileHeaderBytes + 150 * FProtokitePlaytestVideoFile::FrameHeaderBytes);
	FProtokitePlaytestVideoSettings HighBitrate = FromDefaults;
	...
	UProtokitePlaytestSettings* OutOfRange = NewObject<UProtokitePlaytestSettings>(GetTransientPackage());
	...
	const FProtokitePlaytestVideoSettings Kept = FProtokitePlaytestVideoSettings::FromProjectSettings(*OutOfRange);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoFileWritesHeaderAndFramesTest,
	"Protokite.Playtest.Video.File.WritesAWebMFileAPlayerCanRead",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoFileWritesHeaderAndFramesTest::RunTest(const FString& Parameters)
{
	const int64 FrameBytesWritten = 5 + 6 + 7;
	const int64 ExpectedFileBytes = FProtokitePlaytestVideoFile::FileHeaderBytes
		+ 3 * FProtokitePlaytestVideoFile::FrameHeaderBytes + FrameBytesWritten;
	...
	IFileManager::Get().MakeDirectory(*FPaths::GetPath(Path), true);
	{
		...
		TestEqual(TEXT("The header is written"), File.GetBytesWritten(), FProtokitePlaytestVideoFile::FileHeaderBytes);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoEncoderConvertsColoursTest,
	"Protokite.Playtest.Video.Encoder.ConvertsColoursToVideoColours",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoEncoderConvertsColoursTest::RunTest(const FString& Parameters)
{
	struct FCase
	{
		const TCHAR* Name;
	...
	for (const FCase& Case : Cases)
	{
		...
		TArray<uint8> Planes;
		FProtokitePlaytestVideoEncoder::ConvertToVideoColours(Pixels, FIntPoint(2, 2), Planes);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestVideoEncoderEncodesVideoThatDecodesTest,
	"Protokite.Playtest.Video.Encoder.EncodesVideoThatDecodes",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestVideoEncoderEncodesVideoThatDecodesTest::RunTest(const FString& Parameters)
{
	const FIntPoint Size(320, 180);
	FString Error;
	{
		FProtokitePlaytestVideoEncoder OddSize;
	...
	FProtokitePlaytestVideoEncoder Encoder;
	if (!TestTrue(TEXT("The encoder sets up"), Encoder.Initialize(Size, 30, 2000, Error)))
	{
		AddError(Error);
		return true;
	}
	TArray<FProtokitePlaytestEncodedFrame> Refused;
	...
	File.Width = Size.X;
	File.Height = Size.Y;
	TArray<FProtokitePlaytestEncodedFrame> Encoded;
	...
	for (const FProtokitePlaytestEncodedFrame& Frame : Encoded)
	{
	...
	FProtokitePlaytestVideoEncoder::ConvertToVideoColours(MakeTestPixels(Size, 29), Size, SourcePlanes);
