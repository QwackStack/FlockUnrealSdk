...
namespace
{
	...
	{
		Fixture.AnswerConfig(FProtokitePlaytestFakeTransport::Status(200, ConfigBody(GameVersionId, bHeavyAnalytics)));
	...
	{
		return EventsNamed(Fixture.SentPlaytestEvents(), ProtokitePlaytestEvents::PerformanceWindow).Num();
	}
	...
	bool FollowsAnyLevelLoads(const UProtokitePlaytestSubsystem* Playtest)
	{
	...
	bool FollowsBothLevelLoadEvents(const UProtokitePlaytestSubsystem* Playtest)
	{
		return FCoreUObjectDelegates::PreLoadMapWithContext.IsBoundToObject(Playtest)
			&& FCoreUObjectDelegates::PostLoadMapWithWorld.IsBoundToObject(Playtest);
	}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsOffRecordsNothingTest,
	"Protokite.Playtest.HeavyAnalytics.OffRecordsNothing",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsOffRecordsNothingTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsSixWindowsInAMinuteOfPlayTest,
	"Protokite.Playtest.HeavyAnalytics.SixWindowsInAMinuteOfPlay",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsSixWindowsInAMinuteOfPlayTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true);
	...
	const TArray<TSharedPtr<FJsonObject>> Windows = EventsNamed(Fixture.SentPlaytestEvents(), ProtokitePlaytestEvents::PerformanceWindow);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsBackgroundTimeIsNotPlayTest,
	"Protokite.Playtest.HeavyAnalytics.BackgroundTimeIsNotPlay",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsBackgroundTimeIsNotPlayTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true);
	FPlaytestFixture Fixture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsStopsWithPlaytestingTest,
	"Protokite.Playtest.HeavyAnalytics.StopsWithPlaytestingAndDropsTheUnfinishedWindow",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsStopsWithPlaytestingTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsLevelLoadsOfItsOwnGameInstanceTest,
	"Protokite.Playtest.HeavyAnalytics.LevelLoadsOfItsOwnGameInstance",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsLevelLoadsOfItsOwnGameInstanceTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true);
	FPlaytestFixture Fixture;
	...
	const TArray<TSharedPtr<FJsonObject>> Levels = EventsNamed(Events, ProtokitePlaytestEvents::LevelLoaded);
	...
	const TArray<TSharedPtr<FJsonObject>> Windows = EventsNamed(Events, ProtokitePlaytestEvents::PerformanceWindow);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsRecordPlaytestEventTest,
	"Protokite.Playtest.HeavyAnalytics.RecordPlaytestEvent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsRecordPlaytestEventTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true);
	FPlaytestLogCapture Log;
	...
	TestFalse(TEXT("performance_window is the plugin's own"), Fixture.Playtest->RecordPlaytestEvent(ProtokitePlaytestEvents::PerformanceWindow));
	TestFalse(TEXT("level_loaded is the plugin's own"), Fixture.Playtest->RecordPlaytestEvent(ProtokitePlaytestEvents::LevelLoaded));
	...
	TestFalse(TEXT("The Blueprint node does nothing without a playtest subsystem"),
		UProtokitePlaytestLibrary::RecordPlaytestEvent(nullptr, TEXT("boss_defeated"), Properties));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsNeedsTheFlockSdksAnalyticsTest,
	"Protokite.Playtest.HeavyAnalytics.NeedsTheFlockSdksAnalytics",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsNeedsTheFlockSdksAnalyticsTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestHeavyAnalyticsReadsTheEngineFrameCounterTest,
	"Protokite.Playtest.HeavyAnalytics.ReadsTheEngineFrameCounter",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestHeavyAnalyticsReadsTheEngineFrameCounterTest::RunTest(const FString& Parameters)
{
	...
	const UProtokitePlaytestSubsystem* Playtest = NewObject<UProtokitePlaytestSubsystem>(GameInstance);
