...
namespace
{
	...
	FProtokitePlaytestFormAnswers FilledInAnswers()
	{
	...
	{
		return FProtokitePlaytestFormSpool(Folder).CountWaiting();
	}
	...
	{
		FProtokitePlaytestFormSubmission Earlier;
		...
		FString Error;
		return !FProtokitePlaytestFormSpool(Folder).Keep(Earlier, Error).IsEmpty();
	}
}
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingSentThenForgottenTest,
	"Protokite.Playtest.Form.Sending.SentAndForgottenOnceTaken",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingSentThenForgottenTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.Transport->Answer(FeedbackFormRoute, FProtokitePlaytestFakeTransport::Status(200, FormTakenBody()));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingKeptTest,
	"Protokite.Playtest.Form.Sending.KeptWhenItCannotGoNow",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingKeptTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	Fixture.Transport->AnswerInOrder(FeedbackFormRoute, {
		FProtokitePlaytestFakeTransport::Status(503, TEXT("{\"detail\":\"Service Unavailable\"}")),
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingRefusedTest,
	"Protokite.Playtest.Form.Sending.DroppedWhenTheServerRefusesIt",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingRefusedTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestLogCapture Log;
	FPlaytestFixture Fixture;
	Fixture.Transport->AnswerInOrder(FeedbackFormRoute, {
		FProtokitePlaytestFakeTransport::Status(422, TEXT("{\"detail\":\"Missing required answer 'rating'\"}")),
		FProtokitePlaytestFakeTransport::Status(404, TEXT("{\"detail\":\"Session not found for this test\"}")) });
	const FString Folder = StartReadyWithItsOwnFormFolder(Fixture);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingNoFormTest,
	"Protokite.Playtest.Form.Sending.NothingWithoutAPublishedForm",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingNoFormTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestLogCapture Log;
	FPlaytestFixture Fixture;
	Fixture.AnswerConfig(FProtokitePlaytestFakeTransport::Status(200, ConfigBodyWithNoForm()));
	Fixture.Transport->Answer(FeedbackFormRoute, FProtokitePlaytestFakeTransport::Status(200, FormTakenBody()));
	const FString Folder = StartReadyWithItsOwnFormFolder(Fixture);
	ExpectPlaytestStatus(*this, TEXT("Ready"), Fixture.Playtest->GetStatus(), EProtokitePlaytestStatus::Ready);
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingLaterLaunchTest,
	"Protokite.Playtest.Form.Sending.ALaterLaunchSendsWhatWasKept",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingLaterLaunchTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingStillKeptTest,
	"Protokite.Playtest.Form.Sending.StillKeptWhenItCannotGoAgain",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingStillKeptTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestFixture Fixture;
	const FString Folder = FPaths::Combine(Fixture.Folder, TEXT("FeedbackForms"));
	...
	Fixture.Transport->Answer(FeedbackFormRoute, FProtokitePlaytestFakeTransport::Status(503, TEXT("{\"detail\":\"Service Unavailable\"}")));
	StartReadyWithItsOwnFormFolder(Fixture);
	RunPendingPlaytestRetries();
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingCaseWarningTest,
	"Protokite.Playtest.Form.WarnsAboutQuestionsItCannotTellApart",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingCaseWarningTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestLogCapture Log;
	FPlaytestFixture Fixture;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormSendingNoCaseWarningTest,
	"Protokite.Playtest.Form.SaysNothingWhenEveryQuestionIdDiffers",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormSendingNoCaseWarningTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FPlaytestLogCapture Log;
	FPlaytestFixture Fixture;
