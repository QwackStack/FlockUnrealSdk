...
namespace
{
	...
	struct FUploadsTestFolder
	{
		FString Folder = FPaths::ConvertRelativePathToFull(FPaths::Combine(FPaths::ProjectIntermediateDir(),
			TEXT("ProtokitePlaytestTests"), FString::Printf(TEXT("Uploads-%s"), *FGuid::NewGuid().ToString(EGuidFormats::Digits))));
	...
	struct FUploadsFixture
	{
		...
		TSharedRef<FProtokitePlaytestFakeFileUploader> Uploader = MakeShared<FProtokitePlaytestFakeFileUploader>();
		TSharedPtr<FProtokitePlaytestRecordingUploads> Uploads;
		...
		FUploadsFixture()
		{
			...
			const TSharedRef<FProtokiteClient> Client =
				MakeShared<FProtokiteClient>(MakeShared<FFlockHttpClient>(Transport, Logger), Policy, Logger);
			Uploads = MakeShared<FProtokitePlaytestRecordingUploads>(Client, Uploader, Logger);
		}
		...
		static FProtokitePlaytestRecordingSession Session()
		{
			FProtokitePlaytestRecordingSession Value;
		...
		TSharedPtr<FProtokitePlaytestRecordingRun> MakeRunWithRecording(FAutomationTestBase& Test, const FString& Name)
		{
			FString Error;
			const TSharedPtr<FProtokitePlaytestRecordingRun> Run = FProtokitePlaytestRecordingRun::CreateNamedForTesting(
				Scratch.Recordings, EProtokitePlaytestRecordingKind::Playtest, Name, /*ReservedBytes*/ 0, Error);
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestUploadLinkIsNotAnUploadTest,
	"Protokite.Playtest.RecordingUpload.ALinkIsNotAnUpload",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestUploadLinkIsNotAnUploadTest::RunTest(const FString& Parameters)
{
	FUploadsFixture Fixture;
	const TSharedPtr<FProtokitePlaytestRecordingRun> Run = Fixture.MakeRunWithRecording(*this, TEXT("run-a"));
	if (!Run.IsValid())
	{
		return false;
	}
	...
	TOptional<FProtokitePlaytestRecordingUploadOutcome> Outcome;
	Fixture.Uploads->UploadOne(Run.ToSharedRef(), FUploadsFixture::Session(), Fixture.LaunchHeaders(),
		[&Outcome](FProtokitePlaytestRecordingUploadOutcome Result) { Outcome = Result; });
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestUploadDeletesOnSuccessTest,
	"Protokite.Playtest.RecordingUpload.DeletesTheRecordingOnceItIsUploaded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestUploadDeletesOnSuccessTest::RunTest(const FString& Parameters)
{
	FUploadsFixture Fixture;
	const TSharedPtr<FProtokitePlaytestRecordingRun> Run = Fixture.MakeRunWithRecording(*this, TEXT("run-b"));
	if (!Run.IsValid())
	{
		return false;
	}
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestUploadRetriesWithAFreshLinkTest,
	"Protokite.Playtest.RecordingUpload.RetriesOnceWithAFreshLink",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestUploadRetriesWithAFreshLinkTest::RunTest(const FString& Parameters)
{
	FUploadsFixture Fixture;
	const TSharedPtr<FProtokitePlaytestRecordingRun> Run = Fixture.MakeRunWithRecording(*this, TEXT("run-c"));
	if (!Run.IsValid())
	{
		return false;
	}
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestUploadUsesTheSessionsVersionTest,
	"Protokite.Playtest.RecordingUpload.AsksWithTheSessionsGameVersion",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestUploadUsesTheSessionsVersionTest::RunTest(const FString& Parameters)
{
	...
	const TMap<FString, FString> ForUpload =
		FProtokitePlaytestRecordingUploads::MakeUploadHeaders(LaunchHeaders, SessionVersionId);
	...
	const TMap<FString, FString> WithoutSaved = FProtokitePlaytestRecordingUploads::MakeUploadHeaders(LaunchHeaders, FString());
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestUploadWithoutASessionTest,
	"Protokite.Playtest.RecordingUpload.ARecordingWithNoSessionIsNotSent",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestUploadWithoutASessionTest::RunTest(const FString& Parameters)
{
	FUploadsFixture Fixture;
	const TSharedPtr<FProtokitePlaytestRecordingRun> Run = Fixture.MakeRunWithRecording(*this, TEXT("run-d"));
	if (!Run.IsValid())
	{
		return false;
	}
	...
	TOptional<FProtokitePlaytestRecordingUploadOutcome> Outcome;
	Fixture.Uploads->UploadOne(Run.ToSharedRef(), FProtokitePlaytestRecordingSession(), Fixture.LaunchHeaders(),
		[&Outcome](FProtokitePlaytestRecordingUploadOutcome Result) { Outcome = Result; });
