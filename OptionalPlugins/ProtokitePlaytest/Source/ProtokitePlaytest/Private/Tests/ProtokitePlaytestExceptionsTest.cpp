 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestExceptionsWarnWhenNotCapturedTest,
	"Protokite.Playtest.Exceptions.WarnsWhenTheFlockSdkIsNotCapturingThem",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestExceptionsWarnWhenNotCapturedTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestExceptionsQuietWhenCapturedTest,
	"Protokite.Playtest.Exceptions.SaysNothingWhenTheFlockSdkIsCapturingThem",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestExceptionsQuietWhenCapturedTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestExceptionsQuietWhenNotAskedForTest,
	"Protokite.Playtest.Exceptions.SaysNothingWhenThePlaytestDoesNotAskForThem",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestExceptionsQuietWhenNotAskedForTest::RunTest(const FString& Parameters)
{
	FScopedPlaytestSettings Settings(true, UsableUrl);
	FScopedFlockAnalyticsSettings FlockAnalytics(true, /*bCaptureExceptions*/ false);
	FPlaytestLogCapture Log;
