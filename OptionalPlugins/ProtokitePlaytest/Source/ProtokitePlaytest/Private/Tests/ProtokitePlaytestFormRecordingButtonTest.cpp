...
namespace
{
	FProtokitePlaytestForm OneQuestionForm()
	{
		FProtokitePlaytestFormField Field;
		Field.Id = TEXT("notes");
		Field.Type = ProtokitePlaytestFormFieldTypes::Text;
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormRecordingButtonTest,
	"Protokite.Playtest.Form.OffersTheRecordingOnlyWhileOneIsRunning",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormRecordingButtonTest::RunTest(const FString& Parameters)
{
	bool bCanSend = true;
	int32 TimesAsked = 0;
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormNoFalsePromiseTest,
	"Protokite.Playtest.Form.SaysNothingIsOnItsWayWhenSendingDidNotBegin",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormNoFalsePromiseTest::RunTest(const FString& Parameters)
{
	const TSharedRef<SProtokitePlaytestFormWidget> Widget = SNew(SProtokitePlaytestFormWidget)
		.Form(OneQuestionForm())
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtokitePlaytestFormNoRecordingButtonTest,
	"Protokite.Playtest.Form.OffersNoRecordingWhenNothingIsRecorded",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FProtokitePlaytestFormNoRecordingButtonTest::RunTest(const FString& Parameters)
{
	// Nothing bound at all, which is how a form built without the recording half arrives.
	const TSharedRef<SProtokitePlaytestFormWidget> Widget = SNew(SProtokitePlaytestFormWidget).Form(OneQuestionForm());
