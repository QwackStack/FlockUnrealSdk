...
struct FFlockPlaytestRecordingUploadOutcome
{
 ...
 */
class FFlockPlaytestRecordingUploads : public TSharedFromThis<FFlockPlaytestRecordingUploads>
{
public:
	FFlockPlaytestRecordingUploads(const TSharedRef<FFlockProtokiteClient>& InClient,
	 ...
	 */
	void UploadOne(const TSharedRef<FFlockPlaytestRecordingRun>& Run, const FFlockPlaytestRecordingSession& Session,
		const TMap<FString, FString>& LaunchHeaders, TFunction<void(FFlockPlaytestRecordingUploadOutcome)> OnDone);
...
private:
	void AskForLinkAndSend(const TSharedRef<FFlockPlaytestRecordingRun>& Run, const FFlockPlaytestRecordingSession& Session,
	...
	TSharedRef<FFlockProtokiteClient> Client;
