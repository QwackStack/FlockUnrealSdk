...
namespace
{
	...
	{
		FFlockPlaytestPerformanceTimeline Timeline;
		...
		explicit FTimelineUnderTest(double HitchThresholdMs)
			: Timeline(
				...
				[]()
				{
					FFlockPlaytestPerformanceTimeline::FMemoryUse Use;
		...
		bool AddFrame(double FrameSeconds, FFlockPlaytestPerformanceWindow& OutWindow)
		{
		...
		TArray<FFlockPlaytestPerformanceWindow> AddFrames(int32 Count, double FrameSeconds)
		{
			TArray<FFlockPlaytestPerformanceWindow> Windows;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestPerformanceTimelineTenSecondsOfPlayMakeAWindowTest,
	"Flock.Playtest.PerformanceTimeline.TenSecondsOfPlayMakeAWindow",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestPerformanceTimelineTenSecondsOfPlayMakeAWindowTest::RunTest(const FString& Parameters)
{
	// The engine's ticker hands out frame times as floats.
	{
		FTimelineUnderTest Test(60.0);
		const TArray<FFlockPlaytestPerformanceWindow> Windows = Test.AddFrames(3600, static_cast<float>(1.0 / 60.0));
		TestEqual(TEXT("A minute at 60 frames a second makes six windows"), Windows.Num(), 6);
		for (const FFlockPlaytestPerformanceWindow& Window : Windows)
		{
	...
	// A frame with no time is not a frame.
	{
		...
		const TArray<FFlockPlaytestPerformanceWindow> Windows = Test.AddFrames(1, 10.0);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestPerformanceTimelinePercentilesAndHitchesTest,
	"Flock.Playtest.PerformanceTimeline.PercentilesAndHitches",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestPerformanceTimelinePercentilesAndHitchesTest::RunTest(const FString& Parameters)
{
	...
	TArray<double> Empty;
	TestEqual(TEXT("No frames give no percentile"), FFlockPlaytestPerformanceTimeline::Percentile(Empty, 95.0), 0.0);
	return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestPerformanceTimelineUsesTheEngineHitchThresholdTest,
	"Flock.Playtest.PerformanceTimeline.UsesTheEngineHitchThreshold",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestPerformanceTimelineUsesTheEngineHitchThresholdTest::RunTest(const FString& Parameters)
{
	...
	TArray<FFlockPlaytestPerformanceWindow> Windows = Test.AddFrames(200, 0.030);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestPerformanceTimelineLevelLoadLeavesOutTheNextEngineFrameTest,
	"Flock.Playtest.PerformanceTimeline.LevelLoadLeavesOutTheNextEngineFrame",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestPerformanceTimelineLevelLoadLeavesOutTheNextEngineFrameTest::RunTest(const FString& Parameters)
{
	FTimelineUnderTest Test(60.0);
	...
	const TArray<FFlockPlaytestPerformanceWindow> Windows = Test.AddFrames(59, 1.0 / 60.0);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestPerformanceTimelineLeftOutFramesAndDroppedWindowsTest,
	"Flock.Playtest.PerformanceTimeline.LeftOutFramesAndDroppedWindows",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestPerformanceTimelineLeftOutFramesAndDroppedWindowsTest::RunTest(const FString& Parameters)
{
	{
		FTimelineUnderTest Test(60.0);
		...
		const TArray<FFlockPlaytestPerformanceWindow> Windows = Test.AddFrames(1, 1.0);
