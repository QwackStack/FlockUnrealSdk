...
namespace
{
	...
	bool ReadFormFromConfigBody(FAutomationTestBase& Test, const FString& ConfigJson, FFlockPlaytestForm& OutForm)
	{
		...
		if (!Test.TestTrue(FString::Printf(TEXT("The config reads (%s)"), *Error),
			FFlockPlaytestConfig::FromWireObject(Result->ToSharedRef(), Config, Error)))
		{
			return false;
		}
		OutForm = Config.Form;
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestFormBuildsDefaultFormTest,
	"Flock.Playtest.Form.BuildsTheBackendsDefaultForm",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestFormBuildsDefaultFormTest::RunTest(const FString& Parameters)
{
	...
	TArray<FFlockPlaytestFormProblem> Problems = Widget->TrySubmitForTesting();
 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestFormBuildsStudioFormTest,
	"Flock.Playtest.Form.BuildsAStudioEditedFormWithItsOwnIds",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestFormBuildsStudioFormTest::RunTest(const FString& Parameters)
{
	FFlockPlaytestForm Form;
	...
	FFlockPlaytestFormAnswers Sent;
	const TSharedRef<SFlockPlaytestFormWidget> Listening = SNew(SFlockPlaytestFormWidget)
		.Form(Form)
		.OnSubmitted_Lambda([&bSubmitted, &Sent](const FFlockPlaytestFormAnswers& Answers)
		{
			bSubmitted = true;
			Sent = Answers;
		});
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestFormNoFormNoOpenTest,
	"Flock.Playtest.Form.APlaytestWithNoFormOffersNothingToOpen",
	EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)

bool FFlockPlaytestFormNoFormNoOpenTest::RunTest(const FString& Parameters)
{
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FFlockPlaytestFormWithAFormOffersOneTest,
	"Flock.Playtest.Form.APlaytestWithAFormOffersOne",
	EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
