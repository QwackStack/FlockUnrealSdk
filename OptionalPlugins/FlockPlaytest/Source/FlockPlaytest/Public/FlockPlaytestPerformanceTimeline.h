...
struct FLOCKPLAYTEST_API FFlockPlaytestPerformanceWindow
{
 ...
 */
class FLOCKPLAYTEST_API FFlockPlaytestPerformanceTimeline
{
public:
	 ...
	 */
	explicit FFlockPlaytestPerformanceTimeline(TFunction<double()> InReadHitchThresholdMs = nullptr,
	 ...
	 */
	bool AddFrame(double FrameSeconds, uint64 EngineFrameNumber, FFlockPlaytestPerformanceWindow& OutWindow);
